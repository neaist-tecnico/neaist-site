...
const translations = {
    pt: {
        ...
        // Novo no Técnico / New at Técnico
        onboarding_skip: "Saltar para o conteúdo",
        onboarding_hero_eyebrow: "NEAIST · NOVOS ESTUDANTES 2026/27",
        onboarding_hero_title: "NOVO NO<br> TÉCNICO<span>?</span>",
        onboarding_hero_welcome: "Bem-vindo à comunidade.",
        onboarding_hero_intro: "Reunimos num só lugar o que precisas para os teus primeiros passos no Técnico — informação prática, o Guia para Novos Alunos, mentoria, apoio académico e acesso à comunidade NEAIST.",
        onboarding_guide_year_cta: "Consultar o Guia 2026/27",
        onboarding_group_cta: "Pedir acesso ao grupo",
        onboarding_mentor_cta: "Quero um Mentor",
        onboarding_hero_note: "Do primeiro dia ao sentimento de pertença.",
        onboarding_cover_label: "UM GUIA PARA O TEU NOVO CAPÍTULO",
        onboarding_cover_caption: "8 páginas para os teus primeiros passos.",
        onboarding_start_link: "Encontra o teu ponto de partida",
        onboarding_start_eyebrow: "O TEU PONTO DE PARTIDA",
        onboarding_start_title: "Começa aqui",
        onboarding_start_intro: "Três formas simples de começares o teu percurso com o apoio do NEAIST.",
        onboarding_guide_card_label: "01 / ORIENTAÇÃO",
        onboarding_guide_card_title: "Guia para Novos<br> Alunos 2026/27",
        onboarding_guide_card_intro: "Informação prática para organizares os teus primeiros passos no Técnico e em Lisboa.",
        onboarding_guide_cta: "Consultar o Guia",
        onboarding_group_card_label: "02 / COMUNIDADE",
        onboarding_group_card_title: "Grupo de Novos<br> Estudantes",
        onboarding_group_card_intro: "Conhece outros estudantes que também estão a começar o seu percurso no Técnico.",
        onboarding_access_cta: "Pedir acesso",
        onboarding_mentor_card_label: "03 / ACOMPANHAMENTO",
        onboarding_mentor_card_title: "Programa<br> de Mentoria",
        onboarding_mentor_card_intro: "Pede acompanhamento de um estudante que já conhece o Técnico e pode ajudar-te durante a adaptação.",
        onboarding_journey_eyebrow: "UM PASSO DE CADA VEZ",
        onboarding_journey_title: "Primeiros passos",
        onboarding_journey_intro: "Não tens de resolver tudo no primeiro dia.<br> Há um tempo para cada etapa.",
        onboarding_before_title: "Antes de chegares",
        onboarding_before_topics: "Matrícula · Alojamento · Documentação",
        onboarding_before_intro: "Organiza os documentos essenciais e prepara a tua chegada.",
        onboarding_week_title: "Primeira semana",
        onboarding_week_topics: "Fénix · Campus · Cartão · Comunidade",
        onboarding_week_intro: "Conhece as ferramentas, os espaços e as pessoas que vão fazer parte do teu dia a dia.",
        onboarding_month_title: "Primeiro mês",
        onboarding_month_topics: "Rotina · Study Squads · Atividades · Lisboa",
        onboarding_month_intro: "Constrói a tua rotina, encontra apoio académico e começa a participar na comunidade.",
        onboarding_accommodation: "Alojamento",
        onboarding_resources_eyebrow: "O ESSENCIAL, NUM SÓ LUGAR",
        onboarding_resources_title: "O que podes precisar<br> nos primeiros dias",
        onboarding_resources_intro: "Preparámos o Guia para Novos Alunos 2026/2027 com informação prática sobre matrícula, Fénix, transportes, alojamento, NIF, SNS, AIMA e outros passos importantes para começares o teu percurso no Técnico e em Portugal.",
        onboarding_fenix_intro: "Horários, UCs, avaliações e documentos.",
        onboarding_accommodation_intro: "Residências e outras opções.",
        onboarding_nif_intro: "Informação sobre o processo e apoio disponível.",
        onboarding_sns_intro: "Número de utente e acesso aos serviços de saúde.",
        onboarding_aima_intro: "Informação para estudantes que precisam de tratar da sua situação de residência.",
        onboarding_study_tile_intro: "Apoio académico e grupos de estudo.",
        onboarding_mentor_eyebrow: "PROGRAMA DE MENTORIA",
        onboarding_mentor_title: "Não precisas de descobrir tudo sozinho.",
        onboarding_mentor_intro: "O Programa de Mentoria do NEAIST liga novos estudantes a colegas que já conhecem o Técnico e podem acompanhar-te durante a tua adaptação à universidade.",
        onboarding_integration: "Integração",
        onboarding_academic_life: "Vida académica",
        onboarding_community: "Comunidade",
        onboarding_mentor_note: "O pedido de mentoria é feito através do mesmo formulário utilizado para o acolhimento de novos estudantes.",
        onboarding_mentor_learn: "Conhecer o programa",
        onboarding_mentor_art_note: "O primeiro passo pode ser uma conversa.",
        onboarding_new_student: "Novo estudante",
        onboarding_mentor_art_caption: "Quem já chegou.<br> <strong>Ao lado de quem está a chegar.</strong>",
        onboarding_group_art_caption: "Novos percursos.<br> <strong>Um ponto de encontro.</strong>",
        onboarding_group_eyebrow: "A TUA COMUNIDADE, DESDE O INÍCIO",
        onboarding_group_title: "Grupo de Novos<br> Estudantes 2026/27",
        onboarding_group_intro: "Criámos um espaço para os novos estudantes conhecerem colegas, esclarecerem dúvidas e acompanharem as iniciativas de acolhimento do NEAIST.",
        onboarding_group_private: "O link não é público.",
        onboarding_group_privacy: "Para proteger a comunidade e evitar acessos não autorizados, o link de acesso ao grupo de WhatsApp não é público. Preenche um breve formulário e, após confirmação dos teus dados, a equipa do NEAIST envia-te o convite.",
        onboarding_group_note: "Um único formulário para o acolhimento, o acesso ao grupo e o interesse na mentoria.",
        onboarding_study_eyebrow: "STUDY SQUADS · APOIO ACADÉMICO",
        onboarding_study_title: "Estudar também é mais fácil em comunidade.",
        onboarding_study_intro: "Os Study Squads são uma iniciativa de apoio académico do NEAIST que procura aproximar estudantes através de grupos e momentos de estudo.",
        onboarding_study_cta: "Conhecer os Study Squads",
        onboarding_resources_cta: "Explorar recursos académicos",
        onboarding_final_eyebrow: "O TEU PERCURSO. A NOSSA COMUNIDADE.",
        onboarding_final_title: "ESTAMOS AQUI<br> PARA TE RECEBER.",
        onboarding_final_intro: "Começar uma nova etapa pode trazer muitas dúvidas. Não precisas de descobrir tudo sozinho — consulta o Guia, conhece a comunidade e fala connosco sempre que precisares de orientação.",
        onboarding_final_contact: "Precisas de orientação? Fala connosco",
        onboarding_mentor_support: "Apoio da mentoria",
        onboarding_cover_alt: "Capa do Guia para Novos Alunos 2026/2027 do NEAIST",
        onboarding_study_alt: "Cartaz Study Squads do NEAIST",
        onboarding_back_to_top: "Voltar ao topo",
        onboarding_menu_open: "Abrir menu",
        onboarding_menu_close: "Fechar menu",
    ...
    en: {
        ...
        // Novo no Técnico / New at Técnico
        onboarding_skip: "Skip to content",
        onboarding_hero_eyebrow: "NEAIST · NEW STUDENTS 2026/27",
        onboarding_hero_title: "NEW AT<br> TÉCNICO<span>?</span>",
        onboarding_hero_welcome: "Welcome to the community.",
        onboarding_hero_intro: "Everything you need for your first steps at Técnico, all in one place — practical information, the New Students Guide, mentoring, academic support and a way to connect with the NEAIST community.",
        onboarding_guide_year_cta: "Read the 2026/27 Guide",
        onboarding_group_cta: "Request group access",
        ...
        onboarding_start_intro: "Three simple ways to start your journey with support from NEAIST.",
        onboarding_guide_card_label: "01 / GUIDANCE",
        onboarding_guide_card_title: "New Students<br> Guide 2026/27",
        onboarding_guide_card_intro: "Practical information to help you plan your first steps at Técnico and in Lisbon.",
        onboarding_guide_cta: "Read the Guide",
        onboarding_group_card_label: "02 / COMMUNITY",
        onboarding_group_card_title: "New Students<br> Group",
        onboarding_group_card_intro: "Meet other students who are also starting their journey at Técnico.",
        onboarding_access_cta: "Request access",
        onboarding_mentor_card_label: "03 / SUPPORT",
        onboarding_mentor_card_title: "Mentoring<br> Programme",
        onboarding_mentor_card_intro: "Connect with a student who already knows Técnico and can help you settle in.",
        onboarding_journey_eyebrow: "ONE STEP AT A TIME",
        onboarding_journey_title: "Your first steps",
        onboarding_journey_intro: "You don’t have to figure everything out on day one.<br> Take each stage at your own pace.",
        onboarding_before_title: "Before you arrive",
        onboarding_before_topics: "Enrolment · Accommodation · Documents",
        onboarding_before_intro: "Gather your essential documents and prepare for your arrival.",
        onboarding_week_title: "Your first week",
        onboarding_week_topics: "Fénix · Campus · Student card · Community",
        onboarding_week_intro: "Get to know the tools, places and people that will be part of your everyday life.",
        onboarding_month_title: "Your first month",
        onboarding_month_topics: "Routine · Study Squads · Activities · Lisbon",
        onboarding_month_intro: "Build your routine, find academic support and start getting involved in the community.",
        onboarding_accommodation: "Accommodation",
        onboarding_resources_eyebrow: "THE ESSENTIALS, ALL IN ONE PLACE",
        onboarding_resources_title: "What you may need<br> in your first few days",
        onboarding_resources_intro: "Our New Students Guide 2026/2027 brings together practical information on enrolment, Fénix, transport, accommodation, NIF, SNS, AIMA and other important steps as you begin your journey at Técnico and in Portugal.",
        onboarding_fenix_intro: "Timetables, courses, assessments and documents.",
        onboarding_accommodation_intro: "Student residences and other options.",
        onboarding_nif_intro: "Information on getting a tax number and the support available.",
        onboarding_sns_intro: "Your healthcare user number and access to health services.",
        onboarding_aima_intro: "Information for students who need to address their residency status.",
        onboarding_study_tile_intro: "Academic support and study groups.",
        onboarding_mentor_eyebrow: "MENTORING PROGRAMME",
        onboarding_mentor_title: "You don’t have to figure it all out on your own.",
        onboarding_mentor_intro: "NEAIST’s Mentoring Programme connects new students with peers who already know Técnico and can support you as you settle into university life.",
        onboarding_integration: "Settling in",
        onboarding_academic_life: "Academic life",
        onboarding_community: "Community",
        onboarding_mentor_note: "Request a mentor through the same form used to welcome new students.",
        onboarding_mentor_learn: "Explore the programme",
        onboarding_mentor_art_note: "It can all start with a conversation.",
        onboarding_new_student: "New student",
        onboarding_mentor_art_caption: "Those who know the way.<br> <strong>Alongside those just arriving.</strong>",
        onboarding_group_art_caption: "New journeys.<br> <strong>A place to connect.</strong>",
        onboarding_group_eyebrow: "YOUR COMMUNITY, FROM DAY ONE",
        onboarding_group_title: "New Students<br> Group 2026/27",
        onboarding_group_intro: "We’ve created a space for new students to meet peers, ask questions and keep up with NEAIST’s welcome activities.",
        onboarding_group_private: "The invitation link is private.",
        onboarding_group_privacy: "To protect the community and prevent unauthorised access, the WhatsApp group invitation link is not public. Fill in a short form and, once your details have been verified, the NEAIST team will send you an invitation.",
        onboarding_group_note: "One form for getting started, requesting group access and expressing interest in mentoring.",
        onboarding_study_eyebrow: "STUDY SQUADS · ACADEMIC SUPPORT",
        onboarding_study_title: "Studying is easier together, too.",
        onboarding_study_intro: "Study Squads is a NEAIST academic support initiative that brings students together through study groups and sessions.",
        onboarding_study_cta: "Discover Study Squads",
        onboarding_resources_cta: "Explore academic resources",
        onboarding_final_eyebrow: "YOUR JOURNEY. OUR COMMUNITY.",
        onboarding_final_title: "WE’RE HERE<br> TO WELCOME YOU.",
        ...
        onboarding_menu_close: "Close menu",
    ...
    if (pageName === "guia-caloiro.html") {
        ...
        ["alt", "aria-label"].forEach((attribute) => {
            document.querySelectorAll(`[data-onboarding-${attribute}]`).forEach((element) => {
                ...
                element.setAttribute(attribute, getTranslationValue(key));
            });
        });
        return;
    }
